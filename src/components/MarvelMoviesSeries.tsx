...
export const MarvelMoviesSeries = () => {
    ...
    const fetchMoviesAndSeries = async () => {
        ...
        console.log([...seriesData, ...moviesData])
        setSeries([...seriesData, ...moviesData]);
    };

    return (
        <div>
            <button  className='bg-gradient-to-bl from-blue-300 to-blue-500 text-white hover:from-blue-500 hover:to-blue-700 px-4 py-2 rounded-md flex flex-row gap-2' onClick={() => setModalIsOpen(true)}>
                <span>Obtener películas y series de Marvel</span>
